...
{
    public static GameObject GetFirstGameObjectAtMouse(this Camera cam,Vector3 mousePosition,float dist)
    {
        LayerMask layerMask = ~0;

        return GetFirstGameObjectAtMouse(cam, mousePosition, dist, layerMask);
    }
    public static GameObject GetFirstGameObjectAtMouse(this Camera cam, Vector3 mousePosition, float dist, int layermask)
    {
    ...
    public static RaycastHit GetFirstHitAtMouse(this Camera cam, Vector3 mousePosition, float dist)
    {
        Ray ray = cam.ScreenPointToRay(mousePosition);
    ...
    public static RaycastHit GetFirstHitAtMouse(this Camera cam, Vector3 mousePosition, float dist,int layermask)
    {
        Ray ray = cam.ScreenPointToRay(mousePosition);
